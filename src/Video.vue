        ...
        .card.my-3.p-3
            ...
            .row
                .col-sm-3
                    ...
                    play-audio-image(:image-src="video.metadata.thumbnails.default.url", :title="video.title", :url="playableUrl")
                .col-sm-4
                    h6 Status & Uploads
                    div
    ...
    export default {
        ...
        mounted() {
            for(let key of ['artist', 'title', 'genre']) {
                this.$set(this.video.metadata, key, this.video.playlistVideo[key] || (this.guessedMetadata && this.guessedMetadata[key]))
            }
        },
        methods: {},
        components: {
